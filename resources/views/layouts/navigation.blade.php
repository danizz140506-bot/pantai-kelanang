        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @if (in_array(Auth::user()->role, ['Waiter', 'Owner']))
                    ...
                    @endif
                    @if (in_array(Auth::user()->role, ['Kitchen Staff', 'Owner']))
                        <x-nav-link :href="route('kds.index')" :active="request()->routeIs('kds.*')">
                            {{ __('Kitchen Display') }}
                        </x-nav-link>
                    @endif
                    @if (in_array(Auth::user()->role, ['Cashier', 'Owner']))
